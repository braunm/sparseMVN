...
\documentclass[codesnippet]{jss}\usepackage[]{graphicx}\usepackage[]{color}
...
while a sparse symmetric matrix of the \class{dsCMatrix} class requires only 91.5 Kb.
